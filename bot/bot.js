...
var admin = 'ADMIN STEAMID'; //the id of the person that can use /commands and empty the bots inventory via chat etc

//contents of mafile
var TOTP_UserConfig = {"shared_secret":"","serial_number":"","revocation_code":"","uri":"","server_time":,"account_name":"","token_gid":"","identity_secret":"","secret_1":"","status":1,"device_id":"","fully_enrolled":true,"Session":{"SessionID":"","SteamLogin":"%","SteamLoginSecure":"","WebCookie":"","OAuthToken":"","SteamID":}} //object containing shared_secret, identitiy_secret etc. get it by logging in the bot with this software https://github.com/Jessecar96/SteamDesktopAuthenticator/releases (after you log in you will have an mafile created, copy-paste the contents of that file here)
...
var minbet=0.10; //min value PER BET an user can deposit
...
var accesspassword='CHANGE ME'; //you can set this to whatever you want as long as its matching the same variable in include/config.php (this is used to safely access endgame.php and cost.php)
...
var sitename = "csgoreborn.tk"; //site url WITH NO http:// in front of it and NO forward slash ( / ) after it
...
var apik = 'BOT APIKEY'; //steam api key, you can get one at https://steamcommunity.com/dev
////
